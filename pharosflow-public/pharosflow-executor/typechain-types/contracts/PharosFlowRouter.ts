...
export declare namespace PharosFlowRouter {
...
export interface PharosFlowRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approveAdapter"
      | "approvedAdapters"
  ...
  encodeFunctionData(
    ...
    values: [PharosFlowRouter.HopDataStruct[], BytesLike]
  ): string;
...
export interface PharosFlowRouter extends BaseContract {
  connect(runner?: ContractRunner | null): PharosFlowRouter;
  waitForDeployment(): Promise<this>;

  interface: PharosFlowRouterInterface;
  ...
  executePath: TypedContractMethod<
    [hops: PharosFlowRouter.HopDataStruct[], routeId: BytesLike],
    [void],
    "payable"
  >;
