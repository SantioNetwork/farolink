    ...
    return (
        <div className="docs-page">
            ...
            <p className="subtitle">
                ...
                via the FaroLink Layer 4 API Gateway.
            </p>
            ...
            <div className="docs-cards">
                ...
                <div className="docs-card">
                    ...
                    <h3 style={{ color: 'var(--text-1)', marginBottom: 6 }}>FaroLink SDK</h3>
                    <p style={{ color: 'var(--text-3)', fontSize: '0.85rem', marginBottom: 14 }}>
            ...
            <div className="docs-section">
                ...
                <p style={{ color: 'var(--text-2)', lineHeight: 1.7, marginBottom: 12 }}>
                    FaroLink uses an <strong style={{ color: 'var(--text-1)' }}>intent-based execution model</strong>.
                    Your DApp never sends transactions directly — it requests a quote, signs an EIP-712 intent bundle,
                    and submits it. The FaroLink executor cluster handles gas, routing, and cross-chain delivery.
                </p>
...
}, { headers: { 'x-farolink-api-key': YOUR_API_KEY } });
                ...
                <ul className="docs-list">
                    <li>
                        ...
                        <span>
                            ...
                            Pass your key as <code className="docs-inline-code">x-farolink-api-key</code>.
                        </span>
                    </li>
                    <li>
                        <CheckCircle2 size={16} color="var(--success)" style={{ flexShrink: 0 }} />
