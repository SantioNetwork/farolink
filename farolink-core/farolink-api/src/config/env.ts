...
const envSchema = z.object({
  ...
  DATABASE_URL:     z.string().url().default("postgres://pharos:password@localhost:5432/farolink"),
  ...
  ALLOWED_ORIGINS:  z.string().default("http://localhost:5173,http://localhost:4000,https://farolink.vercel.app,https://farolink.xyz,https://www.farolink.xyz,https://app.farolink.xyz"),
